...
public class Vote : BaseEntity, IMustHaveTenant
{
    ...
    /// <summary>
    /// Indicates whether the vote is positive (like) or negative (dislike).
    /// </summary>
    public required bool Like { get; set; }

    /// <summary>
    /// User fingerprint used to identify the voter.
    /// Helps prevent duplicate or abusive voting.
    /// </summary>
    ...
    /// <summary>
    /// User agent string of the client that submitted the vote.
    /// </summary>
