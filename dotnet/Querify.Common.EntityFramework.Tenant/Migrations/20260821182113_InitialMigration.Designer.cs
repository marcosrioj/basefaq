...
namespace Querify.Common.EntityFramework.Tenant.Migrations
{
    ...
    [Migration("20260821182113_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Querify.Common.EntityFramework.Tenant.Entities.ChannelConnection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("CredentialsExpireAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("LastCredentialsRefreshAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("IsDeleted")
                        .HasDatabaseName("IX_ChannelConnection_IsDeleted");

                    b.HasIndex("TenantId")
                        .HasDatabaseName("IX_ChannelConnection_TenantId");

                    b.HasIndex("TenantId", "ProviderKey")
                        .IsUnique()
                        .HasDatabaseName("IX_ChannelConnection_TenantId_ProviderKey");

                    b.HasIndex("TenantId", "IsEnabled", "Status", "Kind")
            ...
            modelBuilder.Entity("Querify.Common.EntityFramework.Tenant.Entities.ChannelConnection", b =>
                {
                    b.HasOne("Querify.Common.EntityFramework.Tenant.Entities.Tenant", null)
                        .WithMany()
