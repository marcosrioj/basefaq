...
{
    [Authorize(Policy = TenantAuthorizationPolicies.Get)]
    [HttpGet("{id:guid}")]
    ...
    [Authorize(Policy = TenantAuthorizationPolicies.GetList)]
    [HttpGet]
    ...
    [Authorize(Policy = TenantAuthorizationPolicies.Create)]
    [HttpPost]
    ...
    [Authorize(Policy = TenantAuthorizationPolicies.Update)]
    [HttpPut("{id:guid}")]
    [ProducesResponseType(typeof(TenantDto), StatusCodes.Status200OK)]
