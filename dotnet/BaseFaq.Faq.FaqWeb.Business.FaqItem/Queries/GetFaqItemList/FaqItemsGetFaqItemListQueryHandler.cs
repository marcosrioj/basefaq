...
namespace BaseFaq.Faq.FaqWeb.Business.FaqItem.Queries.GetFaqItemList;
        ...
        return fieldName.ToLowerInvariant() switch
        {
            ...
            "shortanswer" => isFirst
                ...
                : (desc
                    ...
                    : ((IOrderedQueryable<Persistence.FaqDb.Entities.FaqItem>)query).ThenBy(item => item.ShortAnswer)),
            "additionalinfo" => isFirst
                ...
                : (desc
                    ...
                    : ((IOrderedQueryable<Persistence.FaqDb.Entities.FaqItem>)query).ThenBy(item =>
                        item.AdditionalInfo)),
            "ctatitle" => isFirst
                ...
                : (desc
                    ...
                    : ((IOrderedQueryable<Persistence.FaqDb.Entities.FaqItem>)query).ThenBy(item => item.CtaTitle)),
            "ctaurl" => isFirst
                ? (desc ? query.OrderByDescending(item => item.CtaUrl) : query.OrderBy(item => item.CtaUrl))
                : (desc
                    ? ((IOrderedQueryable<Persistence.FaqDb.Entities.FaqItem>)query)
                    .ThenByDescending(item => item.CtaUrl)
                    : ((IOrderedQueryable<Persistence.FaqDb.Entities.FaqItem>)query).ThenBy(item => item.CtaUrl)),
            "sort" => isFirst
            ...
            "contentrefid" => isFirst
                ...
                : (desc
                    ...
                    : ((IOrderedQueryable<Persistence.FaqDb.Entities.FaqItem>)query).ThenBy(item => item.ContentRefId)),
            "createddate" => isFirst
            ...
            _ => isFirst
                ...
                : ((IOrderedQueryable<Persistence.FaqDb.Entities.FaqItem>)query).ThenByDescending(item =>
                    item.UpdatedDate)
        };
    }
}