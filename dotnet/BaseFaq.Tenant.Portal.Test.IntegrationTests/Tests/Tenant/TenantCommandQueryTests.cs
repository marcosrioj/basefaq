...
using BaseFaq.Tenant.Portal.Business.Tenant.Commands.DeleteTenant;
using BaseFaq.Tenant.Portal.Business.Tenant.Commands.UpdateTenant;
using BaseFaq.Tenant.Portal.Business.Tenant.Queries.GetTenant;
using BaseFaq.Tenant.Portal.Business.Tenant.Queries.GetTenantList;
