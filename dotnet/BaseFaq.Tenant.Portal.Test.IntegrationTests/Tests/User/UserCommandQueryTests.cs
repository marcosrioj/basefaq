...
using BaseFaq.Tenant.Portal.Business.User.Commands.DeleteUser;
using BaseFaq.Tenant.Portal.Business.User.Commands.UpdateUser;
using BaseFaq.Tenant.Portal.Business.User.Queries.GetUser;
using BaseFaq.Tenant.Portal.Business.User.Queries.GetUserList;
using BaseFaq.Tenant.Portal.Test.IntegrationTests.Helpers;
using Microsoft.EntityFrameworkCore;
using Xunit;

namespace BaseFaq.Tenant.Portal.Test.IntegrationTests.Tests.User;
...
public class UserCommandQueryTests
{
    ...
    public async Task GetUserList_SortsByMultipleFields()
    {
        ...
        var userA = new BaseFaq.Common.EntityFramework.Tenant.Entities.User
        {
        ...
        var userB = new BaseFaq.Common.EntityFramework.Tenant.Entities.User
        {
