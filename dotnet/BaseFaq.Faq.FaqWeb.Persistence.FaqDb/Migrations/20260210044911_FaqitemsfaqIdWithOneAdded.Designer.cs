...
namespace BaseFaq.Faq.FaqWeb.Persistence.FaqDb.Migrations
{
    ...
    [Migration("20260210044911_FaqitemsfaqIdWithOneAdded")]
    partial class FaqitemsfaqIdWithOneAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaseFaq.Faq.FaqWeb.Persistence.FaqDb.Entities.ContentRef", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BaseFaq.Faq.FaqWeb.Persistence.FaqDb.Entities.FaqContentRef", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BaseFaq.Faq.FaqWeb.Persistence.FaqDb.Entities.FaqTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BaseFaq.Faq.FaqWeb.Persistence.FaqDb.Entities.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BaseFaq.Faq.FaqWeb.Persistence.FaqDb.Entities.Vote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BaseFaq.Faq.FaqWeb.Persistence.FaqDb.Entities.FaqContentRef", b =>
                {
                    b.HasOne("BaseFaq.Faq.FaqWeb.Persistence.FaqDb.Entities.ContentRef", "ContentRef")
                        .WithMany("Faqs")
            ...
            modelBuilder.Entity("BaseFaq.Faq.FaqWeb.Persistence.FaqDb.Entities.FaqTag", b =>
                {
                    ...
                    b.HasOne("BaseFaq.Faq.FaqWeb.Persistence.FaqDb.Entities.Tag", "Tag")
                        .WithMany("Faqs")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BaseFaq.Faq.FaqWeb.Persistence.FaqDb.Entities.Vote", b =>
                {
                    b.HasOne("BaseFaq.Faq.FaqWeb.Persistence.FaqDb.Entities.FaqItem", "FaqItem")
                        .WithMany("Votes")
